...
log_plays.py consists of: 
  ...
  a. plugin that log details for each task 
...
> 	ok: [127.0.0.1]
  ...
  b. plugin that log details for each task plugin that sends email with archived log file for the tasks with exception 
